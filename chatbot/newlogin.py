...
def main_account_screen(frmmain):
    ...
    Label(main_screen,text="Medical Chatbot \n By Shweta Rani", bg="blue", width="300", height="2", font=("Calibri", 13)).pack()
    Label(main_screen,text="(Select your choice)", bg="blue", width="300", height="2", font=("New Times Roman", 10)).pack()
